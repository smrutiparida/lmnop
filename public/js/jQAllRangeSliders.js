/*! jQRangeSlider 5.7.0 - 2014-03-18 - Copyright (C) Guillaume Gautreau 2012 - MIT and GPLv3 licenses.*/ ! function (a) {
    "use strict";
    a.widget("ui.rangeSliderMouseTouch", a.ui.mouse, {
        ...
        _fillTouchEvent: function (a) {
            var b;
            b = "undefined" == typeof a.targetTouches && "undefined" == typeof a.changedTouches ? a.originalEvent.targetTouches[0] || a.originalEvent.changedTouches[0] : a.targetTouches[0] || a.changedTouches[0], a.pageX = b.pageX, a.pageY = b.pageY
        }
    })
}(jQuery),
function (a) {
    ...
    a.widget("ui.rangeSliderBar", a.ui.rangeSliderDraggable, {
        ...
        _onDragLeftHandle: function (a, b) {
            if (this._cacheIfNecessary(), b.element[0] === this.options.leftHandle[0]) {
                if (this._switchedValues()) return this._switchHandles(), this._onDragRightHandle(a, b), void 0;
        ...
        _onDragRightHandle: function (a, b) {
            if (this._cacheIfNecessary(), b.element[0] === this.options.rightHandle[0]) {
                if (this._switchedValues()) return this._switchHandles(), this._onDragLeftHandle(a, b), void 0;
        ...
        scrollLeft: function (a) {
            return a = a || 1, 0 > a ? this.scrollRight(-a) : (a = this._leftHandle("moveLeft", a), this._rightHandle("moveLeft", a), this.update(), this._triggerMouseEvent("scroll"), void 0)
        },
        scrollRight: function (a) {
            return a = a || 1, 0 > a ? this.scrollLeft(-a) : (a = this._rightHandle("moveRight", a), this._leftHandle("moveRight", a), this.update(), this._triggerMouseEvent("scroll"), void 0)
        },
        zoomIn: function (a) {
...
function (a) {
    ...
    a.widget("ui.dateRangeSliderHandle", a.ui.rangeSliderHandle, {
        ...
        _setOption: function (b, c) {
            return "step" === b ? (this.options.step = c, this._createSteps(), this.update(), void 0) : (a.ui.rangeSliderHandle.prototype._setOption.apply(this, [b, c]), "bounds" === b && this._createBoundsValues(), void 0)
        },
        ...
        _createSteps: function () {
            if (this.options.step === !1 || !this._isValidStep()) return this._steps = !1, void 0;
            var a = new Date(this.options.bounds.min),
                b = new Date(this.options.bounds.max),
                c = a,
                d = 0,
                e = new Date;
...
function (a) {
    ...
    a.widget("ui.dropRangeSlider", a.ui.rangeSlider, {
        ...
        _createTooltip:function() {
            this.toolTip = a("<div class='ui-rangeSlider-tooltip' />").hide().appendTo(this.element)
        },
        _fillTooptip:function(title, img) {
            a("<img src='"+img+"'/>").appendTo(this.toolTip)
            a("<h1>"+title+"</h1>").appendTo(this.toolTip)
            a("<div class='clr'/>").appendTo(this.toolTip)
        },
        _clearTooptip:function() {
            this.toolTip.html("");
        },
        _createMarker: function(b) {
            var that = this;
            var ele =  a( "<div/>" ).css({
                   'left' : b.left
            }).addClass(b.class) ;
            for (var prop in b.data) {
                ele.attr("data-"+prop, b.data[prop]);
            }   
            ele.on( "mouseover", function(event) {
                var this1 = this;
                setTimeout(function(){
                    that.toolTip.css({"left":a(this1).css("left")}) 
                    that._fillTooptip(b.data.title, b.data.img);
                    that.toolTip.slideDown();
                },200);
            }).on( "mouseout", function(event) {
                setTimeout(function(){
                    that.toolTip.slideUp();
                    that._clearTooptip(b.data.title, b.data.img);
                },300);
            });                
            return ele;
        },
        _renderMarkers:function() {
            for(var i=0; i< this.options.markers.length; i++) {
                this._renderMarker({
                    pos : this.options.markers[i].pos,
                    data : this.options.markers[i].data
                });
            }
        },
